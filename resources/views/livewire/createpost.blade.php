        ...
        <div class="title">
            ...
            <div class="form mt-4">
                <div class="flex flex-col text-sm">
                    ...
                    <input class=" appearance-none border border-gray-200 p-2 focus:outline-none focus:border-gray-500" type="text" placeholder="Masukan judul postingan"> 
                </div>

               <div class="text-sm flex flex-col">
                <label for="description" class="font-bold mt-4 mb-2">Isi Postingan</label>
                   <textarea class=" appearance-none w-full border border-gray-200 p-2 h-40 focus:outline-none focus:border-gray-500"  placeholder="Masukan isi postingan"></textarea>
               </div>
            </div>
